# Descarga Constancias de Inscripción de AFIP
...
4. Descargar el BOT. Acá hay 3 opciones:
   ...
   3. Descargar el repositorio con GIT utilizando el comando `git clone https://github.com/abustosp/Desacrga-Constancias-de-Inscripcion.git`
